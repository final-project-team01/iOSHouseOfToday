  ...
  private func cellAutolayout() {
    ...
    if thumnailImageView.translatesAutoresizingMaskIntoConstraints {
      thumnailImageView.snp.makeConstraints {
        ...
        $0.width.equalTo(Metric.popularityProductCellSize.width)
        $0.height.equalTo(Metric.popularityProductCellSize.width)
    ...
    if brandLabel.translatesAutoresizingMaskIntoConstraints {
      brandLabel.snp.makeConstraints {
        ...
        $0.leading.equalTo(thumnailImageView.snp.leading)
...
//    print("frame:", thumnailImageView.frame.size)
