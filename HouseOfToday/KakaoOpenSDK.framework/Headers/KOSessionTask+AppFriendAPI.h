...
/*!
 ...
 @param succeedReceiverIds 전송에 성공한 대상의 사용자 아이디
 @param failureInfo (여러개의 receiver를 지정한 경우) 전송 실패한 일부 대상의 오류 정보
 @param error 호출 실패시의 오류 정보
 */
typedef void(^KOSessionTaskAppFriendMessageSendCompletionHandler)(NSArray<NSString *> *_Nullable succeedReceiverIds,
...
/*!
 ...
 @param receiverIds 메시지 전송 대상의 사용자 아이디 배열. (KOAppFriend.ID)
 @param completionHandler 메시지 전송 완료 핸들러
 @seealso KOAppFriend
 */
+ (nullable instancetype)sendMessageToFriendsWithTemplate:(KMTTemplate *)templateObj
                                              receiverIds:(NSArray<NSString *> *)receiverIds
                                        completionHandler:(nullable KOSessionTaskAppFriendMessageSendCompletionHandler)completionHandler;
...
/*!
 ...
 @seealso KOAppFriend
 */
+ (nullable instancetype)sendMessageToFriendsTaskWithURL:(NSURL *)URL
                                             receiverIds:(NSArray<NSString *> *)receiverIds
                                       completionHandler:(nullable KOSessionTaskAppFriendMessageSendCompletionHandler)completionHandler;
...
/*!
 ...
 @seealso KOAppFriend
 */
+ (nullable instancetype)sendMessageToFriendsTaskWithTemplateId:(NSString *)templateId
                                                   templateArgs:(nullable NSDictionary<NSString *, NSString *> *)templateArgs
                                                    receiverIds:(NSArray<NSString *> *)receiverIds
                                              completionHandler:(nullable KOSessionTaskAppFriendMessageSendCompletionHandler)completionHandler;
