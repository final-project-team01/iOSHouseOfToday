...
#define kServiceAppUrlScheme    @"naver" // url scheme

#define kConsumerKey            @"HVldOr1UoUy7AeDKeDFj" // 클라이언트 아이디
#define kConsumerSecret         @"V3jp9QwMBT" // 클라이언트 시크릿
#define kServiceAppName         @"HouseOfToday" // 앱 이름
